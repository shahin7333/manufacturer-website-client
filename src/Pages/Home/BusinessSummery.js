...
const BusinessSummery = () => {
  ...
  <div class="stat">
    <div class="stat-title">Ordered</div>
    <div class="stat-value text-secondary">31K</div>
    <div class="stat-desc">From 2015 to now</div>
  </div>
  ...
  <div class="stat">
    <div class="stat-title">Site Visit</div>
    <div class="stat-value text-secondary">341K</div>
